function [par, metaPar, txtPar] = test_pars_init_Sargassum_fluitans(metaData)

%% Parameters at T_ref = 25°C
metaPar.model = 'algal';
par.j_ENAm     = 2.152616415995544e-04;    free.j_ENAm     = 1;   units.j_ENAm     = 'mol M_E_N mol M_V^{-1} h^{-1}';     label.j_ENAm     = 'Maximum volume specific nitrogen assimilation';
par.K_N        = 1e-06;                    free.K_N        = 1;   units.K_N        = 'mol N L^{-1}';                     label.K_N        = 'Half-saturation concentration for NO3- and NH4+ uptake';
...
par.eps_I      = 0.5;                      free.eps_I      = 1;   units.eps_I      = 'm^2 mol PSU^{-1}';                  label.eps_I      = 'Effective photon binding efficiency, compound parameter';
par.k_I        = 0.1076;                   free.k_I        = 1;   units.k_I        = 'mol photon mol PSU^{-1} h^{-1}';    label.k_I        = 'Dissociation rate of photosynthetic products';
...
par.j_ENM      = 5.7403e-06;               free.j_ENM      = 1;   units.j_ENM      = 'mol M_E_N mol M_V^{-1} h^{-1}';     label.j_ENM      = 'Volume specific maintenance cost paid by N reserve';
par.j_ECM      = 1.4351e-06;               free.j_ECM      = 1;   units.j_ECM      = 'mol M_E_C mol M_V^{-1} h^{-1}';     label.j_ECM      = 'Volume specific maintenance cost paid by C reserve';
...
par.kap_EC     = 0.9;                      free.kap_EC     = 0;   units.kap_EC     = '-';                                 label.kap_EC     = 'Fraction of rejection flux incorporated back in C reserve';
           ...
           free.kap_EC     = 0;   units.kap_EC     = '-';                                 label.kap_EC     = 'Fraction of rejection flux incorporated back in C reserve';
