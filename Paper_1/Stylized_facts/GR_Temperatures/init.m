...
dataset = dataset_list{3}; % Choose dataset from list of datasets
...
elseif contains(dataset, 'temperatureSimulations')
       ...
       M_V_0 = dW0 / (w_V+   (m_EN_0*w_EN) +   (m_EC_0*w_EC)); % mol V, structural intial mass
        ...
        T_values = [22:2:32]; % Just update this array!
    ...
    forcingConditions.photoPeriod = 1; 
     forcingConditions.nitrogen = 10 * 1e-6; 
