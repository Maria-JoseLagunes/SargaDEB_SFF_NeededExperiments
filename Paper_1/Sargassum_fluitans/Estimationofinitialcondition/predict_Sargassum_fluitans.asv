...
M_V_0 = Wd_0  / (pars. w_V +   (pars.m_EN0_HT2023 * pars.w_EN) +   (pars.m_EC0_HT2023 * pars.w_EC)); % mol V, structural initial mass 

CI_HT= [pars.m_EC0_HT2023, pars.m_EN0_HT2023, M_V_0];
...
[~, mECENV] = ode89(@(t,mECENV) get_mECENV(t,  mECENV, pars, TC_HT2023, forcingVariables), t, CI_HT);% To obtain the information of the implicit equation
if infosgr2 == 0
      info = 0; 
      prdData = []; 
      return; 
...
Wd_HT2023_free = (pars.w_V + pars.w_EN * m_EN + pars.w_EC * m_EC) .* M_V;
Wd_HT2023 = Wd_HT2023_free / (1 - pars.x_moist - pars.x_ash); 
...
for i = 1:length(temps)
    ...
    Wd_0_ash= Ww0_var * dwratio_SF;  %g dW, dry weight
    Wd_0 = Wd_0_ash  * (1 - pars.x_moist - pars.x_ash); 
    M_V_0 = Wd_0 / (pars.w_V + (pars.m_EN0_HS1987 * pars.w_EN) + (pars.m_EC0_HS1987 * pars.w_EC));
    CI = [pars.m_EC0_HS1987, pars.m_EN0_HS1987, M_V_0];
    ...
    Wd_free= (pars.w_V + pars.w_EN * m_EN + pars.w_EC * m_EC) .* M_V;
...
M_V_0_t_Ww_28 = Wd_0_t_Ww_28  / (pars. w_V +   (pars.m_EN0_MG2023a * pars.w_EN) +   (pars.m_EC0_MG2023a * pars.w_EC)); % mol V, structural initial mass 
CI_t_Ww_28 = [pars.m_EC0_MG2023a, pars.m_EN0_MG2023a, M_V_0_t_Ww_28];
...
Wd_MG2023a_28_free= (pars.w_V + pars.w_EN * m_EN + pars.w_EC * m_EC) .* M_V; %g dw org
Wd_MG2023a_28 = Wd_MG2023a_28_free / (1 - pars.x_moist - pars.x_ash); % g dw org +inorga
...
Wd_0_t_Ww_31_ash= Ww0.tWw_MG2023a_31 * dwratio_SF;  %g dW, dry weight
Wd_0_t_Ww_31 = Wd_0_t_Ww_31_ash * (1 - pars.x_moist - pars.x_ash); 
M_V_0_t_Ww_31 = Wd_0_t_Ww_31  / (pars. w_V +   (pars.m_EN0_MG2023a * pars.w_EN) +   (pars.m_EC0_MG2023a * pars.w_EC)) ; % mol V, structural initial mass 
CI_t_Ww_31 = [pars.m_EC0_MG2023a, pars.m_EN0_MG2023a, M_V_0_t_Ww_31];
...
Wd_MG2023a_31_free= (pars.w_V + pars.w_EN * m_EN + pars.w_EC * m_EC) .* M_V;
Wd_MG2023a_31 = Wd_MG2023a_31_free / (1 - pars.x_moist - pars.x_ash); 
...
% 22 
Wd_0_t_Ww_ash= Ww0.tWw_MG2023b_22 * dwratio_SF;  %g dW, dry weight
Wd_0_t_Ww = Wd_0_t_Ww_ash * (1 - pars.x_moist - pars.x_ash); 
M_V_0_t_Ww= Wd_0_t_Ww  / (pars.w_V +   (pars.m_EN0_MG2023b * pars.w_EN) +   (pars.m_EC0_MG2023b * pars.w_EC)); % mol V, structural initial mass 
CI_t_Ww = [pars.m_EC0_MG2023b, pars.m_EN0_MG2023b, M_V_0_t_Ww];
...
% 
% J = zeros(length(mECENV_t_Ww_22),length(colName)); %initializing flux of organic vector
% 
% for i = 1:length(t)
%     [~,J(i,:)] = get_mECENV (t(i), mECENV(i,:),pars, TC_t_Ww_b_22, forcingVariables); 
% end
% 
% 
% % Create a structure
...
Wd_MG2023b_22_free= (pars.w_V + pars.w_EN * m_EN + pars.w_EC * m_EC) .* M_V;
Wd_MG2023b_22 = Wd_MG2023b_22_free /(1 - pars.x_moist - pars.x_ash); 
Ww_MG2023b_22 = Wd_MG2023b_22 ./ dwratio_SF   ; %g wW, wet weight

% 25
% Wd_0_t_Ww = Ww0.tWw_MG2023b_25 * dwratio_SF;  %g dW, dry weight
Wd_0_t_Ww_ash= Ww0.tWw_MG2023b_25 * dwratio_SF;  %g dW, dry weight
Wd_0_t_Ww = Wd_0_t_Ww_ash * (1 - pars.x_moist - pars.x_ash); 
M_V_0_t_Ww= Wd_0_t_Ww  / (pars.w_V +   (pars.m_EN0_MG2023b * pars.w_EN) +   (pars.m_EC0_MG2023b * pars.w_EC)); % mol V, structural initial mass 
CI_t_Ww = [pars.m_EC0_MG2023b, pars.m_EN0_MG2023b, M_V_0_t_Ww];
...
Wd_MG2023b_25_free= (pars.w_V + pars.w_EN * m_EN + pars.w_EC * m_EC) .* M_V;
Wd_MG2023b_25 = Wd_MG2023b_25_free / (1 - pars.x_moist - pars.x_ash); 
Ww_MG2023b_25 = Wd_MG2023b_25 ./ dwratio_SF   ; %g wW, wet weight

% 28
% Wd_0_t_Ww = Ww0.tWw_MG2023b_28* dwratio_SF;  %g dW, dry weight
Wd_0_t_Ww_ash= Ww0.tWw_MG2023b_28 * dwratio_SF;  %g dW, dry weight
Wd_0_t_Ww = Wd_0_t_Ww_ash * (1 - pars.x_moist - pars.x_ash); 
M_V_0_t_Ww = Wd_0_t_Ww  / (pars.w_V +  (pars.m_EN0_MG2023b * pars.w_EN) +   (pars.m_EC0_MG2023b * pars.w_EC)); % mol V, structural initial mass 
CI_t_Ww = [pars.m_EC0_MG2023b, pars.m_EN0_MG2023b, M_V_0_t_Ww];
...
Wd_MG2023b_28_free= (pars.w_V + pars.w_EN * m_EN + pars.w_EC * m_EC) .* M_V;
Wd_MG2023b_28 = Wd_MG2023b_28_free / (1 - pars.x_moist - pars.x_ash); 
Ww_MG2023b_28 = Wd_MG2023b_28 ./ dwratio_SF   ; %g wW, wet weight


% 31 
% Wd_0_t_Ww = Ww0.tWw_MG2023b_31 * dwratio_SF;  %g dW, dry weight
Wd_0_t_Ww_ash= Ww0.tWw_MG2023b_31 * dwratio_SF;  %g dW, dry weight
Wd_0_t_Ww = Wd_0_t_Ww_ash * (1 - pars.x_moist - pars.x_ash); 
M_V_0_t_Ww = Wd_0_t_Ww  / (pars.w_V +  (pars.m_EN0_MG2023b * pars.w_EN) +   (pars.m_EC0_MG2023b * pars.w_EC)); % mol V, structural initial mass 
CI_t_Ww = [pars.m_EC0_MG2023b, pars.m_EN0_MG2023b, M_V_0_t_Ww];
...
Wd_MG2023b_31_free= (pars.w_V + pars.w_EN * m_EN + pars.w_EC * m_EC) .* M_V;
Wd_MG2023b_31 = Wd_MG2023b_31_free / (1 - pars.x_moist - pars.x_ash); 
...
Wd = surface.I_J_O2_VE2023_HL * smcoeff_SF * dwratio_SF;  % g dW SM = g cm-2 1.5 in cm-2 from VE2023, same for HL and LL
M_V = Wd / (pars.w_V +   (pars.m_EN0_VE2023 * pars.w_EN) +   (pars.m_EC0_VE2023* pars.w_EC)); %mol V
