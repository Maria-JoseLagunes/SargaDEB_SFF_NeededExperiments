...
comment.HT2023_CNratio = 'Time 500 days for it to be at equilibrium';
...
weights.I_J_O2_VE2023_HL=  weights.I_J_O2_VE2023_HL * 0.5;
% weights.I_J_O2_VE2023_HL=  weights.I_J_O2_VE2023_HL * 0.;
...
% data.psd.m_EC_0 = 0.002;     units.psd.m_EC_0 = 'mol C / mol V';       label.psd.T_AL = 'initial carbon reserve density';
% data.psd.m_EN_0 = 0.01;     units.psd.m_EC_0 = 'mol N / mol V';       label.psd.T_AL = 'initial nitrogen reserve density';
% weights.psd = setweights(data.psd, []);
...
% metaData.T_typical  = C2K(25); % K, 
% 
% metaData.data_1     = {'T-RGR'; 't-Ww'; 'I-J_O2'; 'I_Ww'; 'I_CgdW'; 'I_NgdW'}; 
% 
% %% set data
% % zero-variate data
% 
% 
% data.CNratio = 32.4;    units.CNratio = 'mol C mol N-1';    
% label.CNratio = 'CN ratio';           bibkey.CNratio = 'Hatt2024';
% comment.CNratio = 'Average from Hatt et al 2024 Figure 4, The green dashed line represents the average nutrient content value for sargasso reported by Lapointe et al. 2021'; 
% 
% 
% data.CPratio = 886;    units.CPratio = 'mol C mol P-1';    
% label.CPratio = 'CP ratio';           bibkey.CPratio  = 'Hatt2024';
% comment.CPratio = 'Average from Hatt et al 2024 Figure 4, The green dashed line represents the average nutrient content value for sargasso reported by Lapointe et al. 2021'; 
% 
% 
% data.NPratio = 27.8;    units.NPratio = 'mol N mol P-1';    
% label.NPratio = 'NP ratio';           bibkey.NPratio  = 'Hatt2024';
% comment.NPratio = 'Average from Hatt et al 2024 Figure 4, The green dashed line represents the average nutrient content value for sargasso reported by Lapointe et al. 2021'; 
% 
% 
% 
% Ww0.CNratio = 2.5; units.Ww0.CNratio = 'g Ww'; label.Ww0.CNratio = 'Initial wet weight'; 
% time.CNratio = 500 ;  units.time.CNratio = 'd'; label.time.CNratio = 'days';
% 
% 
% temp.CNratio = C2K(25); units.temp.CNratio = 'K'; label.temp.CNratio = 'temperature';
% light.CNratio = 500  * 1e-6 * 3600; units.light.CNratio = 'mol gamma m-2 s-1'; label.light.CNratio = "light intensity"; 
% nitrogen.CNratio = 1.5 * 1e-6 ; units.nitrogen.CNratio = 'mol NO3 + NH4 L-1'; label.nitrogen.CNratio = "N concentration"; 
% CO2.CNratio = 0.002 ; units.CO2.CNratio = 'mol CO2 L-1'; label.CO2.tWw_MG2023a_28 = "C concentration"; 
% phosphorous.CNratio  =  0.10 * 1e-6; units.phosphorous.CNratio = 'mol P043- L-1 '; label.phosphorous.CNratio = "P concentration"; 
% photoPeriod.CNratio   = 0; units.photoPeriod.CNratio = '-'; label.photoPeriod.CNratio = "Photoperiod"; 
% 
% 
% 
% 
...
% data_t_Ww_28 = [ ... % d, g Ww
%                  1 12;
%                  6 13.985915288639502;
%                 11 16.633802598053865;
%                 16 16.59154894752555;
%                 21 14.816901041131903];
% 
% %time (daysCNratio ), total wet weight (g Ww)
% data_t_Ww_31 = [ ... % d, g Ww
%                  1 12;
%                  6 14.999999806578728;
%                 11 18.788732198674722;
%                 16 17.253520871589778;
%                 21 16.774647712972374 ]; %Not 5 10 as that represents day 0 to 5 to 10
% 
% 
% data.tWw_MG2023a_28 = data_t_Ww_28(1:3, [1 2]); %Select 
% units.tWw_MG2023a_28 = {'d', 'g Ww'}; label.tWw_MG2023a_28 = {'days' , 'wet weight'}; 
...
% temp.tWw_MG2023a_28 = C2K(28); units.temp.tWw_MG2023a_28 = 'K'; label.temp.tWw_MG2023a_28 = 'temperature';
% light.tWw_MG2023a_28 = mean([435 581]) * 1e-6 * 3600; units.light.tWw_MG2023a_28 = 'mol gamma m-2 s-1'; label.light.tWw_MG2023a_28 = "light intensity"; 
% nitrogen.tWw_MG2023a_28 = (0.06 + 3.49) * 1e-6 ; units.nitrogen.tWw_MG2023a_28 = 'mol NO3 + NH4 L-1'; label.nitrogen.tWw_MG2023a_28 = "N concentration"; 
% CO2.tWw_MG2023a_28 = 0.002 ; units.CO2.tWw_MG2023a_28 = 'mol CO2 L-1'; label.CO2.tWw_MG2023a_28 = "C concentration"; 
% phosphorous.tWw_MG2023a_28  =  0.10 * 1e-6; units.phosphorous.tWw_MG2023a_28 = 'mol P043- L-1 '; label.phosphorous.tWw_MG2023a_28 = "P concentration"; 
% photoPeriod.tWw_MG2023a_28   = 1; units.photoPeriod.tWw_MG2023a_28 = '-'; label.photoPeriod.tWw_MG2023a_28 = "Photoperiod"; 
% 
% bibkey.tWw_MG2023a_28 = 'magana-gallegos_growth_2023'; 
% 
...
% temp.tWw_MG2023a_31 = C2K(31); units.temp.tWw_MG2023a_31 = 'K'; label.temp.tWw_MG2023a_31 = 'temperature';
% light.tWw_MG2023a_31 = mean([435 581]) * 1e-6 * 3600; units.light.tWw_MG2023a_31 = 'mol gamma m-2 s-1'; label.light.tWw_MG2023a_31 = "light intensity"; 
% nitrogen.tWw_MG2023a_31 = (0.06 + 3.49) * 1e-6 ; units.nitrogen.tWw_MG2023a_31 = 'mol NO3 + NH4 L-1'; label.nitrogen.tWw_MG2023a_31 = "N concentration"; 
% CO2.tWw_MG2023a_31 = 0.002 ; units.CO2.tWw_MG2023a_31 = 'mol CO2 L-1'; label.CO2.tWw_MG2023a_31 = "C concentration"; 
% phosphorous.tWw_MG2023a_31  =  0.10 * 1e-6; units.phosphorous.tWw_MG2023a_31 = 'mol P043- L-1 '; label.phosphorous.tWw_MG2023a_31 = "P concentration"; 
% photoPeriod.tWw_MG2023a_31   = 1; units.photoPeriod.tWw_MG2023a_31 = '-'; label.photoPeriod.tWw_MG2023a_31 = "Photoperiod"; 
% 
% bibkey.tWw_MG2023a_31 = 'magana-gallegos_growth_2023'; 
% 
...
% time.tWw_MG2023b_22  = 5;  units.time.tWw_MG2023b_22  = 'd'; label.time.tWw_MG2023b_22   = 'days';
% WWfMG2023b_22 = 2.^(data_MG2023b_T_RGR(1,2) * time.tWw_MG2023b_22 ) * Ww0.tWw_MG2023b_22 ;
% data.tWw_MG2023b_22 = [1 Ww0.tWw_MG2023b_22 ; time.tWw_MG2023b_22   WWfMG2023b_22 ];
% units.tWw_MG2023b_22 = {'d', 'g Ww'}; label.tWw_MG2023b_22 = {'days', 'wet weight'};
% 
% 
% temp.tWw_MG2023b_22  = C2K(data_MG2023b_T_RGR(1,1)); units.temp.tWw_MG2023b_22  = 'K'; label.temp.tWw_MG2023b_22  = 'temperature'; 
% light.tWw_MG2023b_22 = 508 * 1e-6 * 3600; units.light.tWw_MG2023b_22 = 'mol gamma m-2 s-1'; label.light.tWw_MG2023b_22 = "light intensity"; 
% nitrogen.tWw_MG2023b_22 = 3.5 * 1e-6 ; units.nitrogen.tWw_MG2023b_22 = 'mol NO3 + NH4 L-1'; label.nitrogen.tWw_MG2023b_22 = "N concentration"; 
% CO2.tWw_MG2023b_22 = 0.002 ; units.CO2.tWw_MG2023b_22 = 'mol CO2 L-1'; label.CO2.tWw_MG2023b_22 = "C concentration"; 
% phosphorous.tWw_MG2023b_22  =  0.10 * 1e-6; units.phosphorous.tWw_MG2023b_22 = 'mol P043- L-1 '; label.phosphorous.tWw_MG2023b_22 = "P concentration"; 
% photoPeriod.tWw_MG2023b_22   = 1; units.photoPeriod.tWw_MG2023b_22 = '-'; label.photoPeriod.tWw_MG2023b_22 = "Photoperiod"; 
% 
% bibkey.tWw_MG2023b_22  = 'magana-gallegos_temperature_2023'; 
% 
...
% 
% Ww0.tWw_MG2023b_25 = 6; units.Ww0.tWw_MG2023b_25   = 'g Ww'; label.Ww0.tWw_MG2023b_25   = 'Initial wet weight';
% time.tWw_MG2023b_25  = 6;  units.time.tWw_MG2023b_25  = 'd'; label.time.tWw_MG2023b_25   = 'days';
% WWfMG2023b_25 = 2.^(data_MG2023b_T_RGR(2,2) * time.tWw_MG2023b_25 ) * Ww0.tWw_MG2023b_25;
% data.tWw_MG2023b_25 = [1 Ww0.tWw_MG2023b_25 ; time.tWw_MG2023b_25   WWfMG2023b_25 ];
% units.tWw_MG2023b_25 = {'d', 'g Ww'}; label.tWw_MG2023b_25 = {'days', 'wet weight'};
% 
% 
% temp.tWw_MG2023b_25  = C2K(data_MG2023b_T_RGR(2,1)); units.temp.tWw_MG2023b_25  = 'K'; label.temp.tWw_MG2023b_25  = 'temperature'; 
% light.tWw_MG2023b_25 = 508 * 1e-6 * 3600; units.light.tWw_MG2023b_25 = 'mol gamma m-2 s-1'; label.light.tWw_MG2023b_25 = "light intensity"; 
% nitrogen.tWw_MG2023b_25 = 3.5 * 1e-6 ; units.nitrogen.tWw_MG2023b_25 = 'mol NO3 + NH4 L-1'; label.nitrogen.tWw_MG2023b_25 = "N concentration"; 
% CO2.tWw_MG2023b_25 = 0.002 ; units.CO2.tWw_MG2023b_25 = 'mol CO2 L-1'; label.CO2.tWw_MG2023b_25 = "C concentration"; 
% phosphorous.tWw_MG2023b_25  =  0.10 * 1e-6; units.phosphorous.tWw_MG2023b_25 = 'mol P043- L-1 '; label.phosphorous.tWw_MG2023b_25 = "P concentration"; 
% photoPeriod.tWw_MG2023b_25   = 1; units.photoPeriod.tWw_MG2023b_25 = '-'; label.photoPeriod.tWw_MG2023b_25 = "Photoperiod"; 
% 
% 
% bibkey.tWw_MG2023b_25  = 'magana-gallegos_temperature_2023'; 
...
% 
% Ww0.tWw_MG2023b_28 = 6; units.Ww0.tWw_MG2023b_28   = 'g Ww'; label.Ww0.tWw_MG2023b_28   = 'Initial wet weight';
% time.tWw_MG2023b_28  = 6;  units.time.tWw_MG2023b_28  = 'd'; label.time.tWw_MG2023b_28   = 'days';
% WWfMG2023b_28 = 2.^(data_MG2023b_T_RGR(3,2) * time.tWw_MG2023b_28 ) * Ww0.tWw_MG2023b_28;
% data.tWw_MG2023b_28 = [1 Ww0.tWw_MG2023b_28 ; time.tWw_MG2023b_28   WWfMG2023b_28 ];
% units.tWw_MG2023b_28 = {'d', 'g Ww'}; label.tWw_MG2023b_28 = {'days', 'wet weight'};
% 
% 
% temp.tWw_MG2023b_28  = C2K(data_MG2023b_T_RGR(3,1)); units.temp.tWw_MG2023b_28  = 'K'; label.temp.tWw_MG2023b_28  = 'temperature'; 
% light.tWw_MG2023b_28 = 508 * 1e-6 * 3600; units.light.tWw_MG2023b_28 = 'mol gamma m-2 s-1'; label.light.tWw_MG2023b_28 = "light intensity"; 
% nitrogen.tWw_MG2023b_28 = 3.5 * 1e-6 ; units.nitrogen.tWw_MG2023b_28 = 'mol NO3 + NH4 L-1'; label.nitrogen.tWw_MG2023b_28 = "N concentration"; 
% CO2.tWw_MG2023b_28 = 0.002 ; units.CO2.tWw_MG2023b_28 = 'mol CO2 L-1'; label.CO2.tWw_MG2023b_28 = "C concentration"; 
% phosphorous.tWw_MG2023b_28  =  0.10 * 1e-6; units.phosphorous.tWw_MG2023b_28 = 'mol P043- L-1 '; label.phosphorous.tWw_MG2023b_28 = "P concentration"; 
% photoPeriod.tWw_MG2023b_28   = 1; units.photoPeriod.tWw_MG2023b_28 = '-'; label.photoPeriod.tWw_MG2023b_28 = "Photoperiod"; 
% 
% 
% bibkey.tWw_MG2023b_28  = 'magana-gallegos_temperature_2023'; 
...
% 
% Ww0.tWw_MG2023b_31 = 6; units.Ww0.tWw_MG2023b_31   = 'g Ww'; label.Ww0.tWw_MG2023b_31   = 'Initial wet weight';
% time.tWw_MG2023b_31  = 6;  units.time.tWw_MG2023b_31  = 'd'; label.time.tWw_MG2023b_31   = 'days';
% WWfMG2023b_31 = 2.^(data_MG2023b_T_RGR(4,2) * time.tWw_MG2023b_31) * Ww0.tWw_MG2023b_31 ;
% data.tWw_MG2023b_31 = [1 Ww0.tWw_MG2023b_31 ; time.tWw_MG2023b_31  WWfMG2023b_31];
% units.tWw_MG2023b_31 = {'d', 'g Ww'}; label.tWw_MG2023b_31 = {'days', 'wet weight'};
% 
% 
% temp.tWw_MG2023b_31  = C2K(data_MG2023b_T_RGR(4,1)); units.temp.tWw_MG2023b_31  = 'K'; label.temp.tWw_MG2023b_31  = 'temperature'; 
% light.tWw_MG2023b_31 = 508 * 1e-6 * 3600; units.light.tWw_MG2023b_31 = 'mol gamma m-2 s-1'; label.light.tWw_MG2023b_31 = "light intensity"; 
% nitrogen.tWw_MG2023b_31 = 3.5 * 1e-6 ; units.nitrogen.tWw_MG2023b_31 = 'mol NO3 + NH4 L-1'; label.nitrogen.tWw_MG2023b_31 = "N concentration"; 
% CO2.tWw_MG2023b_31 = 0.002 ; units.CO2.tWw_MG2023b_31 = 'mol CO2 L-1'; label.CO2.tWw_MG2023b_31 = "C concentration"; 
% phosphorous.tWw_MG2023b_31  =  0.10 * 1e-6; units.phosphorous.tWw_MG2023b_31 = 'mol P043- L-1 '; label.phosphorous.tWw_MG2023b_31 = "P concentration"; 
% photoPeriod.tWw_MG2023b_31   = 1; units.photoPeriod.tWw_MG2023b_31 = '-'; label.photoPeriod.tWw_MG2023b_31 = "Photoperiod"; 
% 
% 
% bibkey.tWw_MG2023b_31  = 'magana-gallegos_temperature_2023'; 
...
% 
% 
% data.I_J_O2_VE2023_HL(:,1) =  data_I_J_O2_VE2023_HL(:,1) * 1e-6 * 3600; % convert light intensity from micro mol to mol and to from seconds to hours
% data.I_J_O2_VE2023_HL(:,2) =  data_I_J_O2_VE2023_HL(:,2) * 1e-6; % convert gross photosynthesis from micro mol to mol 
% units.I_J_O2_VE2023_HL = {'mol quanta m-2 h-1', 'mol O2 cm-2 h-1'};
% label.I_J_O2_VE2023_HL = {'Light intensity', 'gross photosynthesis rate'}; 
% 
% surface.I_J_O2_VE2023_HL = 1.5 ; units.surface.I_J_O2_VE2023_HL = 'cm^2'; label.surface.I_J_O2_VE2023_HL = 'Initial surface'; 
% temp.I_J_O2_VE2023_HL = C2K(23); units.temp.I_J_O2_VE2023_HL = 'K'; label.temp.I_J_O2_VE2023_HL = 'temperature'; 
...
% 
% 
% data.I_J_O2_VE2023_LL(:,1) =  data_I_J_O2_VE2023_LL(:,1) * 1e-6 * 3600; % convert light intensity from micro mol to mol and from seconds to hours
% data.I_J_O2_VE2023_LL(:,2) =  data_I_J_O2_VE2023_LL(:,2) * 1e-6; % convert gross photosynthesis from micro mol to mol 
% units.I_J_O2_VE2023_LL = {'mol quanta m-2 h-1', 'mol O2 cm-2 h-1'};
% label.I_J_O2_VE2023_LL= {'Light intensity', 'gross photosynthesis rate'}; 
% 
% surface.I_J_O2_VE2023_LL = 1.5 ; units.surface.I_J_O2_VE2023_LL = 'cm^2'; label.surface.I_J_O2_VE2023_LL = 'Initial surface'; 
% temp.I_J_O2_VE2023_LL = C2K(23); units.temp.I_J_O2_VE2023_LL = 'K'; label.temp.I_J_O2_VE2023_LL = 'temperature'; 
...
% Ww0.tWw_VE2023_LL = 1.5 ; units.Ww0.tWw_VE2023_LL   = 'g Ww'; label.Ww0.tWw_VE2023_LL   = 'Initial wet weight';
% time.tWw_VE2023_LL  = 21;  units.time.tWw_VE2023_LL  = 'd'; label.time.tWw_VE2023_LL   = 'days';
% WWf.tWw_VE2023_LL = Ww0.tWw_VE2023_LL *  (( (data_VE_I_GR(1:4,3) / 100) + 1).^ (time.tWw_VE2023_LL));
% data.tWw_VE2023_LL = [data_VE_I_GR(1:4,2) WWf.tWw_VE2023_LL ] ;
% units.tWw_VE2023_LL = {'d', 'g Ww'}; label.tWw_VE2023_LL = {'days', 'wet weight'};
% 
% data.C_gdW_VE2023_LL = [data_VE_I_GR(4,1) data_VE_I_GR(4,4) ] ;
...
% Ww0.tWw_VE2023_ML = 1.5 ; units.Ww0.tWw_VE2023_ML   = 'g Ww'; label.Ww0.tWw_VE2023_ML   = 'Initial wet weight';
% time.tWw_VE2023_ML  = 21;  units.time.tWw_VE2023_ML  = 'd'; label.time.tWw_VE2023_ML   = 'days';
% WWf.tWw_VE2023_ML = Ww0.tWw_VE2023_ML *  (( (data_VE_I_GR(5:8,3) / 100) + 1).^ (time.tWw_VE2023_ML));
% data.tWw_VE2023_ML = [data_VE_I_GR(5:8,2) WWf.tWw_VE2023_ML ] ;
% units.tWw_VE2023_ML = {'micro mol E m{-2} s{-1}', 'g Ww'}; label.tWw_VE2023_ML = {'days', 'wet weight'};
% 
% data.C_gdW_VE2023_ML = [data_VE_I_GR(8,1) data_VE_I_GR(8,4) ] ;
...
% Ww0.tWw_VE2023_HL = 1.5 ; units.Ww0.tWw_VE2023_HL   = 'g Ww'; label.Ww0.tWw_VE2023_HL   = 'Initial wet weight';
% time.tWw_VE2023_HL  = 21;  units.time.tWw_VE2023_HL  = 'd'; label.time.tWw_VE2023_HL   = 'days';
% WWf.tWw_VE2023_HL = Ww0.tWw_VE2023_HL *  (( (data_VE_I_GR(9:12,3) / 100) + 1).^ (time.tWw_VE2023_HL));
% data.tWw_VE2023_HL = [data_VE_I_GR(9:12,2) WWf.tWw_VE2023_HL ] ;
% units.tWw_VE2023_HL = {'d', 'g Ww'}; label.tWw_VE2023_HL = {'days', 'wet weight'};
% 
% data.C_gdW_VE2023_HL = [data_VE_I_GR(12,1) data_VE_I_GR(12,4) ] ;
...
% weights.tWw_MG2023a_31 =  weights.tWw_MG2023a_31 * 1;
% 
% weights.tWw_MG2023b_22 = weights.tWw_MG2023b_22 * 1; 
% weights.tWw_MG2023b_25 = weights.tWw_MG2023b_25 * 1; 
% weights.tWw_MG2023b_28 = weights.tWw_MG2023b_28 * 1; 
% weights.tWw_MG2023b_31 = weights.tWw_MG2023b_31 * 1; 
% 
% 
...
% 
% 
% auxData.Ww0.CNratio = Ww0.CNratio;
% 
% 
% auxData.Ww0.tWw_MG2023a_28 = Ww0.tWw_MG2023a_28;
% auxData.Ww0.tWw_MG2023a_31 = Ww0.tWw_MG2023a_31;
...
% 
% 
% auxData.time.CNratio = time.CNratio;
% 
% auxData.time.tWw_MG2023a_28 = time.tWw_MG2023a_28;
% auxData.time.tWw_MG2023a_31 = time.tWw_MG2023a_31;
% 
...
% set1 = {'tWw_MG2023a_28','tWw_MG2023a_31'}; subtitle1 = {'Data of wet weight MG2023a'};
% set2 = {'tWw_MG2023b_22','tWw_MG2023b_25', 'tWw_MG2023b_28', 'tWw_MG2023b_31'}; subtitle2 = {'Data of wet weight MG2023b'};
% set3 = {'I_J_O2_VE2023_HL','I_J_O2_VE2023_LL'}; subtitle3 = {'Data of VE2024'};  
% set4 = {'tWw_VE2023_LL','tWw_VE2023_ML', 'tWw_VE2023_HL'}; subtitle4 = {'Data of VE2024_Ww'};
% set5 = {'C_gdW_VE2023_LL','C_gdW_VE2023_ML', 'C_gdW_VE2023_HL'}; subtitle5 = {'Data of VE2024_CgdW'};
% set6 = {'N_gdW_VE2023_LL','N_gdW_VE2023_ML', 'N_gdW_VE2023_HL'}; subtitle6 = {'Data of VE2024_NgdW'};
% 
