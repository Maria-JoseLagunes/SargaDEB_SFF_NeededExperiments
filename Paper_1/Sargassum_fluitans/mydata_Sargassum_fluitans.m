...
phosphorous.HT2023_CNratio  =  0.10 * 1e-6; units.phosphorous.HT2023_CNratio = 'mol P0_4^{3-} L^{-1}'; label.phosphorous.HT2023_CNratio = "P concentration"; 
...
phosphorous.tWw_HS1987_12  =  15 * 1e-6; units.phosphorous.tWw_HS1987_12 = 'mol P0_4^{3-} L^{-1}'; label.phosphorous.tWw_HS1987_12 = "P concentration"; 
    ...
    for i =  1:nst
        nm_exp = string(nm(i));
         if contains(nm_exp,'Starvation')
            weights.(sprintf('tWw_%s', nm_exp))= weights.(sprintf('tWw_%s', nm_exp)) * 5;
            weights.(sprintf('CNratio_%s', nm_exp)) = weights.(sprintf('CNratio_%s', nm_exp)) * 5;
            ...
            if isfield(time,(nm_exp))
             ...
             weights.(nm_exp) =  weights.(nm_exp) * 5;
