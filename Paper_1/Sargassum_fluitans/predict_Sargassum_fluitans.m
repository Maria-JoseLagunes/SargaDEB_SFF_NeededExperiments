...
% To obtain the information of the implicit equation
if infosgr2 == 0
      info = 0; 
      prdData = []; 
end
...
Wd_ash = surface.I_J_O2_VE2023_HL * smcoeff_SF * dwratio_SF;  % g dW SM = g cm-2 1.5 in cm-2 from VE2023, same for HL and LL
Wd = Wd_ash * (1 - pars.x_moist - pars.x_ash); % g dW organic
...
if contains(pwd,'Identifiability')
    ...
    for i = 1:length(datasets)
        ...
        Wd_0_ash= Ww0.(dataset) * dwratio_SF;    %g dW, dry weight organic + inorganic
    ...
    for i = 1:length(datasets)
        ...
        Wd0_N_ash= Ww0_N * dwratio_SF;    %g dW, dry weight organic + inorganic
